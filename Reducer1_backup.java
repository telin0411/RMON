...
public class Reducer1_backup extends MapReduceBase
  ...
  class statistics_func{
    ...
    private double maxCTPass, minCTPass, maxCTFail, minCTFail;
    ...
    while (values.hasNext()){
      ...
      double pastSeq = Double.parseDouble(pastSeqs+pastTime);
      double currentSeq = Double.parseDouble(seq+time);
      /** Dealing with passes **/
      if (result.equals("P") && currentSeq > pastSeq){
      ...
      else if (result.equals("F") && currentSeq > pastSeq){
    ...
    /*if(inputKey.equals("4F03,I CHECK") || inputKey.equals("4F02,I CHECK1 OQC")){
